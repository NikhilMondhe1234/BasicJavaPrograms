...
public class CalenderStack
{
	...
	public static void main(String[] args) 
	{
		...
		MyStack<String> stackDays=new MyStack<String>(); 
		MyStack<Integer> stackDates=new MyStack<Integer>();
		MyStack<String> calender=new MyStack<String>();
		WeekDaysForStack weekdays=new WeekDaysForStack();
